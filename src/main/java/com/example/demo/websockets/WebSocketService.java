...
/**
 * WebSocketService provides a simplified API for sending WebSocket messages
 * from various parts of the application to the client. This service acts as a
 * bridge between application events and WebSocket communication, encapsulating
 * the underlying WebSocketHandler functionalities.
 *
 * <p>
 * Through this service, other components can trigger client updates for actions
 * like reloading the interface, updating clocks, or sending messages, without
 * needing direct access to the WebSocketHandler.
 * </p>
 */
@Service
public class WebSocketService {
	...
	/**
	 * Sends an update message for the clocks on the client side. This method helps
	 * keep the client clocks in sync with server-side time updates.
	 */
