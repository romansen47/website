...
public interface Config {
     ...
     *
     * @param isUciEngineActive true to activate the UCI engine, false to deactivate it
     */
    ...
    /**
     * Sets the depth for the UCI evaluation engine, influencing the extent of analysis
