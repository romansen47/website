...
/**
 * Abstract helper class for chess-related utilities and shared logic.
 * This class provides methods to manage chess piece images and game attributes.
 * It also facilitates access to configurations and WebSocket services.
 */
public abstract class ChessHelper {

	/**
	 * Configuration settings related to the view, used to manage and access
	 * various display settings, such as board orientation, square size,
	 * and visual preferences for the chess application.
	 */
	@Autowired
	 ...
	 * predefined keys. This provides access to core elements, field data,
	 * and various states required across the game lifecycle.
	 */
	@Autowired
	protected Attributes attributes;

	/**
	 * WebSocket service used for handling real-time communication and updates
	 * with the frontend. This service is essential for synchronizing the
	 * chessboard, clocks, and game states across different user interfaces.
	 */
	@Autowired
